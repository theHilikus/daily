...
func newDummyEventSource() *dummyEventSource {
	...
	return &dummyEventSource{
		...
		today: []event{
			...
			{id: "5", title: "A very long current event with zoom meeting that is longer than the rest", location: "https://www.zoom.us/2345", details: "details4 [Link text Here](https://link-url-here.org)", start: now, end: now.Add(time.Minute), response: tentative},
